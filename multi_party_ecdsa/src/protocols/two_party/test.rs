...
fn two_party_test() {
    ...
    let mut party_one_sign_new =
        party_one::SignPhase::new(&sign_message).unwrap();
    party_one_sign_new.load_keygen_result(&party_one_keygen_result).unwrap();
    ...
    let mut party_two_sign_new =
        party_two::SignPhase::new(&sign_message).unwrap();
    party_two_sign_new.load_keygen_result(&party_two_keygen_result).unwrap();
