...
use online_offline::examples::config::TwoPartyConfig;
use online_offline::examples::console::Console;
use message::message::Message;
use message::message_process::{MsgProcess, ProcessMessage};
use online_offline::communication::receiving_messages::ReceivingMessages;
use online_offline::communication::sending_messages::SendingMessages;
use online_offline::protocols::two_party::message::PartyTwoMsg;
use online_offline::protocols::two_party::party_two;
use p2p::{Info, Node};
    ...
    fn process(
        ...
        match received_msg {
            ...
            ReceivingMessages::SignOnlineBegin(msg) => {
                sending_msg = self.party_two_sign.process_begin_sign_online(index, msg)?;
            }
            _ => {
