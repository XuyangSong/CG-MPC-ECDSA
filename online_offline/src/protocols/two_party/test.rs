...
fn two_party_test() {
    ...
    let message_int: BigInt = BigInt::from_hex(&sign_message).unwrap();
    let message: FE = ECScalar::from(&message_int);
    ...
    let party_one_keygen_result = party_one_key_gen_init
        ...
        .unwrap();
    let mut party_one_sign_new = party_one::SignPhase::new().unwrap();
    party_one_sign_new
    ...
    let party_two_keygen_result = party_two_key_gen_init
        ...
        .unwrap();
    let mut party_two_sign_new = party_two::SignPhase::new().unwrap();
    party_two_sign_new
