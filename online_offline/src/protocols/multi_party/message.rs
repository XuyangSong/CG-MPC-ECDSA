...
use multi_party_ecdsa::utilities::promise_sigma_multi::{PromiseProof, PromiseState};
...
pub enum MultiSignMessage {
    ...
    PhaseFiveStepOneTwoOfflineMsg(SignPhaseFiveStepOneTwoOffline),
}
...
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct SignPhaseFiveStepOneTwoOffline {
    pub l_i: FE,
    pub a_i: GE,
    pub b_i: GE, 
    pub dl_proof: DLogProof<GE>
