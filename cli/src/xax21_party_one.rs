...
use multi_party_ecdsa::protocols::two_party::xax21::party_one;
use p2p::{Info, Node};
...
impl MsgProcess<Message> for PartyOne {
    fn process(
        ...
        match received_msg {
            ReceivingMessages::XAXTwoKeyGenMessagePartyTwo(msg) => {
            ...
            ReceivingMessages::XAXTwoSignMessagePartyTwo(msg) => {
                sending_msg = self
                    .party_one_sign
