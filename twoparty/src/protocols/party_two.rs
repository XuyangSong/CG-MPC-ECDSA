...
use super::eccl_setup::{
    encrypt, eval_scal, eval_sum, CLGroup, Ciphertext as CLCiphertext, ECCLcipher, PK as HSMCLPK,
};
...
pub struct Party2Public {
    ...
    pub ec_base: GE,
    pub ec_pk: GE,
    pub encrypted_secret_share: ECCLcipher,
}
    ...
    pub fn verify_setup_and_zkcldl_proof(
        ...
        match proof_verify.is_ok() && setup_verify.is_ok() {
            true => Ok(Party2Public {
                ...
                ec_base: hsmcl_public.ec_pub_base.clone(),
                ec_pk: hsmcl_public.ec_pub_key.clone(),
...
impl EphKeyGenSecondMsg {
    pub fn verify_and_decommit(
        // TBD: comm_witness no need here, use it outside.
...
impl PartialSig {
    pub fn compute(
        ...
        let clcipher = CLCiphertext {
            c1: party_two_public.encrypted_secret_share.c1.clone(),
            c2: party_two_public.encrypted_secret_share.c2.clone(),
        };
        let c2 = eval_scal(&clcipher, &v);
