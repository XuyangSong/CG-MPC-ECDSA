...
use super::eccl_setup::{
    decrypt, verifiably_encrypt, CLDLProof, CLGroup, Ciphertext as CLCiphertext, ECCLcipher, PK, SK,
};
...
impl EphKeyGenSecondMsg {
    // TBD: Seperate the verify commitment, verify proof and generate next msg.
    pub fn verify_commitments_and_dlog_proof(
        ...
        // TBD: Replase the flag, when catch false, throw error.
        let mut flag = true;
